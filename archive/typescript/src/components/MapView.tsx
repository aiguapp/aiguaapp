...
export function MapView({ incidents }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-xl font-bold text-gray-800 mb-4">Mapa de Catalua</h2>

      <div className="relative bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg h-96 overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <svg className="w-full h-full" viewBox="0 0 100 100">
            <path
              d="M20,30 L40,20 L60,25 L80,20 L85,40 L75,60 L60,75 L40,80 L25,70 L15,50 Z"
              fill="currentColor"
      ...
      <div className="mt-4 flex items-center justify-center gap-6 text-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-gray-600">Aten</span>
        </div>
        <div className="flex items-center gap-2">
